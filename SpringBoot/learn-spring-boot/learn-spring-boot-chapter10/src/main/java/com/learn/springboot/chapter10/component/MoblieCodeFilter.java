 ...
 **/
@Component
public class MoblieCodeFilter extends OncePerRequestFilter {
        private String defaultFilterUrl="/login/mobile";
    ...
    protected void doFilterInternal(HttpServletRequest request,
            ...
            if(defaultMethod.equalsIgnoreCase(request.getMethod())
                ...
                if(code==null||code.equals("")){
                  ...
                  String sessionCode= request.getParameter("mobile_code");
